...
function techJavaWheel() {
    ...
    var svg = d3.select("#javaWheel").append("svg").attr("width", diameter).attr("height", diameter) // affects the center of the wheel. Increase value to lower center.
...
//# sourceMappingURL=techJavaWheel-compiled.js.map